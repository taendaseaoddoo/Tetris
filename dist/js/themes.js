...
define({
    ...
    'custom': {
        ...
        complexBlocks: {
            line:     ['../images/custom/line.png'],
            square:   ['../images/custom/square.png'],
            arrow:    ['../images/custom/arrow.png'],
            rightHook:['../images/custom/rightHook.png'],
            leftHook: ['../images/custom/leftHook.png'],
            rightZag: ['../images/custom/rightZag.png'],
            leftZag:  ['../images/custom/leftZag.png']
        }
    },
    'candy': {
        background: '#040304',
